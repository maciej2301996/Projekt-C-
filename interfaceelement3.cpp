...
InterfaceElement3::InterfaceElement3(QString name, QGraphicsItem *parent):  QGraphicsRectItem(parent)
{
...
InterfaceElement3::InterfaceElement3(QGraphicsItem* parent): QGraphicsRectItem(parent)
{
    // rysowanie prostokąta
    setRect(0,0,26,240);
    QBrush brush;
