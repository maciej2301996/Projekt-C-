...
DodajPrzedmiot::DodajPrzedmiot(QWidget*)
{
...
void DodajPrzedmiot::interface()
{
    ...
    QObject::connect(this,SIGNAL(sygnal()),school,SLOT(dodajPrzedmiot()));
}

void DodajPrzedmiot::wprowadzdane()
{

}

void DodajPrzedmiot::zamknijokno()
{
