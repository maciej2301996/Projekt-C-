...
DodajUzytkownik::DodajUzytkownik(QWidget*)
{
...
DodajUzytkownik::~DodajUzytkownik()
{

}

void DodajUzytkownik::interface()
{
    Imie        = new QLineEdit();
    ...
    QObject::connect(this,SIGNAL(sygnal()),school,SLOT(dodajUzytkownik()));
}

void DodajUzytkownik::wprowadzdane()
{
    imie = Imie->text();
...
void DodajUzytkownik::zamknijokno()
{
    this->hide();
}
